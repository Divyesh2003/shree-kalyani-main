                            ...
                            <div class="shop-topbar-wrapper d-flex justify-content-between align-items-center">
                                <div class="grid-list-option d-flex">
                                    ...
                                    <div class="toolbar-short-area d-md-flex align-items-center">
                                        ...
                                        <label>Sort By:</label>
                                        <form method="GET" action="{{ route('category',$category->slug) }}" id="sortForm">
                                                                ...
                                                                <div class="product-image">
                                                                    ...
                                                                    <div class="product-action d-flex justify-content-between">
                                                                        ...
                                                                        <ul class="d-flex">
                                                                            ...
                                                                            <li>
                                                                                <a href="#quick-view-modal-container"  class="quick-view-btn" data-bs-toggle="modal" data-product-id="{{ $product->id }}" title="Quick View"><i class="ion-ios-search-strong"></i></a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>

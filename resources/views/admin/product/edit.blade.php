                                    ...
                                    <form class="row g-3 needs-validation" id="category" method="POST" action="{{ route('admin.product.update',$product->id) }}"   enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="mt-2 mb-3">
                                          ...
                                          <div class="mt-2 mb-3">
                                            ...
                                            <input id="name" name="name" class="form-control form-control-lg" value="{{ $product->name}}" type="text" placeholder="Enter Product Name" required>
                                      ...
                                      <div class="mt-2 mb-3">
                                        ...
                                        <select class="js-example-basic-single form-control" name="supplier_id">
                                         <option value=""> Selected Supplier</option>
                                          ...
                                          <option value="{{ $supllier->id }}" @if($product->supplier_id == $supllier->id) selected @endif>{{ $supllier->firstname}} {{ $supllier->lastname}}</option>
                                          @endforeach
                                        </select>
                                        <div class="invalid-feedback">
                                        ...
                                        <div class="mt-2 mb-3">
                                          ...
                                          <input id="blouse_work" name="blouse_work" class="form-control form-control-lg" value="{{ $product->blouse_work }}" type="text" placeholder="Enter Product Material Blouse Work" >
                                          <div class="invalid-feedback">
                                              Please Enter Product Blouse Work.
                                            </div>  
                                      </div>
                                        <div class="mt-2 mb-3">
                                        ...
                                        <div class="mt-2 mb-3">
                                            ...
                                            <input id="discount" name="discount" class="form-control form-control-lg" value="{{ $product->discount }}" type="text" placeholder="Enter Product Discount" >
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-check">
                                          <input class="form-check-input" type="checkbox" name="arraival" value="A" id="arraival" @if($product->arraival) checked @endif>

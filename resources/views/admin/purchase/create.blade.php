                ...
                <g id="Icon" transform="translate(27.000000, 15.000000)">
                    ...
                    <div class="col-md-6">
                      <dl class="row mb-2">
                        ...
                        <dd class="col-sm-6 d-flex justify-content-md-end">
                          <div class="w-px-150">
                            <input type="number" class="form-control" placeholder="3905" value="" id="invoiceId" fdprocessedid="3br3p">
                          </div>
                        </dd>
                        <dt class="col-sm-6 mb-2 mb-sm-0 text-md-end">
                        ...
                        <dd class="col-sm-6 d-flex justify-content-md-end">
                          <div class="w-px-150">
                            <input type="date" class="form-control date-picker flatpickr-input" placeholder="YYYY-MM-DD" name="date">
                          </div>
                        </dd>
                        <dt class="col-sm-6 mb-2 mb-sm-0 text-md-end">
                        ...
                        <dd class="col-sm-6 d-flex justify-content-md-end">
                          <div class="w-px-150">
                            <input type="date" class="form-control date-picker flatpickr-input" placeholder="YYYY-MM-DD" name="due_date">
                          </div>
                        </dd>
                      </dl>
                    </div>
                  ...
                  <div class="row p-sm-3 p-0">
                    <div class="col-md-6 col-sm-5 col-12 mb-sm-0 mb-4">
                      ...
                      <p class="mb-1">
                        <input type="text" class="form-control mb-2" name="vendor_name" placeholder="Vendor Name">
                      </p>
                      <p class="mb-1">
                        <textarea class="form-control" rows="2" placeholder="Vendor Address" name="vendor_address"></textarea>
                      </p>
                      <p class="mb-1">
                        <input type="number" class="form-control mb-2" name="vendor_phone" placeholder="Vendor Phone">
                      </p>
                      <p class="mb-0">
                        <input type="email" class="form-control mb-2" name="vendor_email" placeholder="Vendor Email">
                      </p>
                    </div>
                  </div>
                  <hr class="mx-n4">
            ...
            <div class="col-lg-3 col-12 invoice-actions">
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  <button type="submit" class="btn btn-secondary d-grid w-100" fdprocessedid="9dgm6t">Save</button>
                </div>
              </div>
              <div>

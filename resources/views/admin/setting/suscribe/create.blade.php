...
@section('meta_description', "Country Create")
@section('meta_keywords', "Country Create")
    ...
    @endif
                <div class="col-lg-12 mb-4 order-0">
                    <div class="card mb-4">
                        <div class="row">
                            <div class="col-sm-6">
                              <h5 class="card-header">Country Crate</h5> 
                            </div>
                            <div class="card-body m-3"> 
                                <form class="row g-3 needs-validation" id="expense" method="POST" action="{{ route('admin.country.store') }}" novalidate>
                                    @csrf()
                                    @method('POST')
                                      <div class="mt-2 mb-3">
                                        <label for="name" class="form-label">Name</label>
                                        <input id="name" name="name" class="form-control form-control-lg" type="text" placeholder="Enter Country Title" required>
                                      ...
                                      <div class="mt-2 mb-3">
                                        ...
                                        <input id="code" name="code" class="form-control form-control-lg" type="text" placeholder="Enter Country Code" required>
                                        <div class="invalid-feedback">

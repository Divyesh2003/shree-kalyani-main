    ...
    @endif
                <div class="col-lg-12 mb-4 order-0">
                    <div class="card mb-4">
                        <div class="row">
                            <div class="col-sm-6">
                              <h5 class="card-header">User Permission Crate</h5> 
                            </div>
                            {{-- <div class="col-sm-6">
                              <a href="{{ route('admin.category.create')}}" class="btn btn-primary float-end mt-3 me-3">Create</a>
                            </div> --}}
                            <div class="card-body m-3"> 
                                <form class="row g-3 needs-validation" id="category" method="POST" action="{{ route('admin.user.permission.store') }}"   enctype="multipart/form-data" novalidate>
                                    @csrf()
                                    @method('POST')
                                    <div class="mt-2 mb-3">
                                        <label for="largeSelect" class="form-label">Name</label>
                                        <input id="name" name="name" class="form-control form-control-lg" type="text" placeholder="Enter Name">
                                      </div>
                                      <div class="mt-2 mb-3">
                                        <label for="description" class="form-label">Description</label>
                                        <input id="description" name="description" class="form-control form-control-lg" type="text" placeholder="Enter Description">
                                      </div>

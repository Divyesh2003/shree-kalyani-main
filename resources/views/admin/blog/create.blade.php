    ...
    @endif
                <div class="col-lg-12 mb-4 order-0">
                    <div class="card mb-4">
                        <div class="row">
                            <div class="col-sm-6">
                              <h5 class="card-header">Blog Crate</h5> 
                            </div>
                            {{-- <div class="col-sm-6">
                              <a href="{{ route('admin.category.create')}}" class="btn btn-primary float-end mt-3 me-3">Create</a>
                            </div> --}}
                            <div class="card-body m-3"> 
                                <form class="row g-3 needs-validation" id="blog " method="POST" action="{{ route('admin.blog.store') }}"   enctype="multipart/form-data" novalidate>
                                    @csrf()
                                    @method('POST')
                                    <div class="mt-2 mb-3">

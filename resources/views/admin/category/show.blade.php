            ...
            <div class="row">
                <div class="col-lg-12 mb-4 order-0">
                    <div class="card mb-4">
                      <div class="row">
                        <div class="col-sm-6">
                          <h5 class="card-header">Category Show</h5> 
                        </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                    @if($category->parent_id!= null) {{ $category->parent->name }} @endif
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>
                              ...
                              <div class="row mt-3">
                                <div class="col-12">
                                    <a href="{{ route('admin.category.edit',$category->id)}}" class="btn btn-primary" type="submit">Edit</a>
                                    <a href="{{ route('admin.category.index')}}" class="btn btn-primary ms-3">Back</a>

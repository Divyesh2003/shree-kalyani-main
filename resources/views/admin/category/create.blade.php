                    ...
                    <div class="card mb-4">
                        <div class="row">
                            ...
                            <div class="card-body m-3"> 
                                <form class="row g-3 needs-validation" id="category" method="POST" action="{{ route('admin.category.store') }}" novalidate>
                                    @csrf()
                                    @method('POST')
                                    <div class="mt-2 mb-3">
                                      ...
                                      <div class="mt-2 mb-3">
                                        ...
                                        <input id="name" name="name" class="form-control form-control-lg" type="text" placeholder="Enter Category Name" required>
                                      ...
                                      <div class="mt-2 mb-3">
                                        ...
                                        <input id="slug" name="slug" class="form-control form-control-lg" type="text" placeholder="Enter Category Slug" required>
                                        <div class="invalid-feedback">
                                      ...
                                      <div class="mt-2 mb-3">
                                        ...
                                        <input id="meta_title" name="meta_title" class="form-control form-control-lg" type="text" placeholder="Enter Meta Title" >
                                        <div class="invalid-feedback">

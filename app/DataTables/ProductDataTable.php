...
class ProductDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function(Product $product) {
            ...
            ->addColumn('item_type',function (Product $product)
            {
                if ($product->item_type == "" || is_null($product->item_type)) {
                    return "";
                }
                return $product->category->name;
            }) 
            ->addColumn('image', function (Product $product){
                return '<div class="w-10 h-10 img-fluid"><img alt="" class="img-fluid rounded-circle" src="/'.$product->image.'" style="width: 40px;height: 40px;"></div>';
            })
        ...
        ->rawColumns(['action','status','item_type','image']);
    }
    ...
    {
        // dd( $model->newQuery()->with('category'));

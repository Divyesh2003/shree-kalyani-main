    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function(Purchase $purchase) {
            return '<span style="display:flex">
                <a href="' . route('admin.purchase.show', $purchase->id) . '" class="flex items-center mr-3 text-theme-23 " style="padding-right:8px; color:#997a00;"><svg  class="h-4 w-4 " xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" />  <circle cx="12" cy="12" r="3" /></svg> </a>
                 <a href="' . route('admin.purchase.edit', $purchase->id) . '" class="flex items-center mr-3 text-theme-10" style="color:green;"> <svg class="h-6 w-6" <svg  width="20px"  height="20px"  viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  
                 <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" /> 
                  <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" /></svg> </a> 
                 <form action="' . route('admin.purchase.destroy', $purchase->id) . '" method="POST" class="delete m-0" onsubmit="return confirmDelete(event)">
                 ' . csrf_field() . '
                 ' . method_field("DELETE") . '
